        ...
        <div className="footerCard flex">
          ...
          <div className="footerLinks grid">
            ...
            <div data-aos="fade-up" data-aos-duration="5000" className="linkGroup">
              ...
              <li className="footerList flex"><FiChevronRight className='icon' />India</li>
            </div>

          </div>

          <div className="footerDiv flex">
            <small>Explore The World Now</small>
            <small>© {currentYear} Aditya Kumar   Made with ❤️ and lots of coffee.</small>
          </div>
